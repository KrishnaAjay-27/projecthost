...
$productsQuery = "SELECT pd.*, c.name as category_name, sc.name as subcategory_name, tp.brand, tp.species
                  FROM product_dog pd
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($product['species']); ?></td>
                        <td class="<?php echo $product['status'] == 0 ? 'status-active' : 'status-inactive'; ?>">
                            <?php echo $product['status'] == 0 ? 'Active' : 'Inactive'; ?>
                        </td>
                        <td>
                            <button onclick="viewVariants(<?php echo $product['product_id']; ?>)" class="view-variants-btn">View Variants</button>
                            <a href="edit_product.php?pid=<?php echo $product['product_id']; ?>" class="edit-btn">Edit</a>
