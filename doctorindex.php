...
$uid = $_SESSION['uid'];
$query = "SELECT name FROM d_registration WHERE lid='$uid'";
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="profile-dropdown">
            ...
            <a href="view_profile_doctor.php">View Profile</a>
            <a href="edit_profile_doctor.php">Edit Profile</a>
                
            </div>
        </div>
 
      
        <a href="view_chat_message.php">chats </a>
        </div>
